	...
	await pool.query(
		`INSERT INTO ${Q_LAB_AUTH_USER} (${COL_AUTH.USERNAME}, ${COL_AUTH.PASSWORDHASH}, ${COL_AUTH.DISPLAYNAME}, ${COL_AUTH.ROLECODE}, ${COL_AUTH.ACTIVE})
		 ...
		 ON CONFLICT (${COL_AUTH.USERNAME}) DO UPDATE SET
		   ...
		   ${COL_AUTH.DISPLAYNAME} = COALESCE(EXCLUDED.${COL_AUTH.DISPLAYNAME}, ${COL_AUTH.DISPLAYNAME}),
		   ${COL_AUTH.ROLECODE} = COALESCE(EXCLUDED.${COL_AUTH.ROLECODE}, ${COL_AUTH.ROLECODE}),
