...
VALUES ('isa-doc', 'tickets', 'ticket', 'Ticket', NULL,
  '["code"]'::jsonb, '[{"name":"code","kind":"string","required":true},{"name":"titulo","kind":"string"},{"name":"solicitante","kind":"string"},{"name":"fechaSolicitud","kind":"string"},{"name":"fechaEntrega","kind":"string"},{"name":"resumen","kind":"string"},{"name":"estado","kind":"string"},{"name":"proyecto","kind":"string"},{"name":"pagina","kind":"string"},{"name":"bodyModule","kind":"string"},{"name":"sqlModule","kind":"string"},{"name":"normativa","kind":"json"},{"name":"commits","kind":"json"},{"name":"cambiosBd","kind":"json"},{"name":"meta","kind":"json"}]'::jsonb, '[{"key":"assets","child":{"project":"isa-doc","page":"tickets","entity":"imgbb-asset"},"fk":{"ticketId":"code"},"cascadeDelete":true}]'::jsonb, '["code","titulo","solicitante","resumen"]'::jsonb, 10)
...
VALUES ('isa-doc', 'tickets', 'imgbb-asset', 'Asset imgbb', NULL,
  '["filename"]'::jsonb, '[{"name":"filename","kind":"string","required":true},{"name":"ticketId","kind":"string"},{"name":"sha1","kind":"string"},{"name":"url","kind":"string"},{"name":"display_url","kind":"string"},{"name":"thumb","kind":"string"},{"name":"width","kind":"number"},{"name":"height","kind":"number"},{"name":"size","kind":"number"}]'::jsonb, '[]'::jsonb, '["filename","ticketId"]'::jsonb, 20)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('isa-doc', 'postman', 'endpoint', 'Endpoint API', NULL,
  '["apiProject","id"]'::jsonb, '[{"name":"apiProject","kind":"string","required":true},{"name":"id","kind":"string","required":true},{"name":"name","kind":"string"},{"name":"method","kind":"string"},{"name":"path","kind":"string"},{"name":"folder","kind":"string"},{"name":"tags","kind":"json"},{"name":"body","kind":"json"},{"name":"overrides","kind":"json"}]'::jsonb, '[]'::jsonb, '["name","path","apiProject"]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('isa-doc', 'bitacora', 'revisado', 'Revisado bitácora', NULL,
  '["key"]'::jsonb, '[{"name":"key","kind":"string","required":true},{"name":"revisado","kind":"boolean"},{"name":"proyecto","kind":"string"},{"name":"pagina","kind":"string"}]'::jsonb, '[]'::jsonb, '["key"]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('isa-doc', 'patyia', 'prompt', 'Prompt PatyIA', NULL,
  '["path"]'::jsonb, '[{"name":"path","kind":"string","required":true},{"name":"title","kind":"string"},{"name":"body","kind":"string"},{"name":"tags","kind":"json"}]'::jsonb, '[]'::jsonb, '["path","title"]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('isa-doc', 'openai', 'file-meta', 'Metadato archivo OpenAI', NULL,
  '["id"]'::jsonb, '[{"name":"id","kind":"string","required":true},{"name":"filename","kind":"string"},{"name":"purpose","kind":"string"},{"name":"meta","kind":"json"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('isa-doc', 'clientesis-schema', 'table', 'Tabla DER', NULL,
  '["tableid"]'::jsonb, '[{"name":"tableid","kind":"string","required":true},{"name":"tableref","kind":"string"},{"name":"rowname","kind":"string"},{"name":"columns","kind":"json"}]'::jsonb, '[]'::jsonb, '["tableref","rowname"]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('isa-doc', 'codegen', 'state', 'Estado codegen', NULL,
  '["id"]'::jsonb, '[{"name":"id","kind":"string","required":true},{"name":"body","kind":"json"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('patyia', 'api', 'catalog-endpoint', 'Endpoint catálogo', NULL,
  '["id"]'::jsonb, '[{"name":"id","kind":"string","required":true},{"name":"entity","kind":"string"},{"name":"name","kind":"string"},{"name":"method","kind":"string"},{"name":"pathTemplate","kind":"string"},{"name":"hostVar","kind":"string"},{"name":"description","kind":"string"},{"name":"bodyTemplate","kind":"string"},{"name":"authBearer","kind":"boolean"}]'::jsonb, '[]'::jsonb, '["name","entity"]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('patyia', 'prompts', 'prompt-file', 'Archivo prompt', NULL,
  '["relPath"]'::jsonb, '[{"name":"relPath","kind":"string","required":true},{"name":"content","kind":"string"},{"name":"hash","kind":"string"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('patyia', 'caches', 'identidades', 'Cache identidades', NULL,
  '["id"]'::jsonb, '[{"name":"id","kind":"string","required":true},{"name":"body","kind":"json"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 20)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('clientesis', 'postman-catalog', 'cursos', 'cursos', NULL,
  '["slug"]'::jsonb, '[{"name":"slug","kind":"string","required":true},{"name":"name","kind":"string"},{"name":"itemCount","kind":"number"},{"name":"payload","kind":"json"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 10)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('clientesis', 'postman-catalog', 'planes-de-estudio', 'planes de estudio', NULL,
  '["slug"]'::jsonb, '[{"name":"slug","kind":"string","required":true},{"name":"name","kind":"string"},{"name":"itemCount","kind":"number"},{"name":"payload","kind":"json"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 11)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('clientesis', 'postman-catalog', 'drivers', 'drivers', NULL,
  '["slug"]'::jsonb, '[{"name":"slug","kind":"string","required":true},{"name":"name","kind":"string"},{"name":"itemCount","kind":"number"},{"name":"payload","kind":"json"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 12)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
...
VALUES ('clientesis', 'postman-catalog', 'permisos', 'permisos', NULL,
  '["slug"]'::jsonb, '[{"name":"slug","kind":"string","required":true},{"name":"name","kind":"string"},{"name":"itemCount","kind":"number"},{"name":"payload","kind":"json"}]'::jsonb, '[]'::jsonb, '[]'::jsonb, 13)
ON CONFLICT (projectslug, sectionslug, entityslug) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description,
  primarykeys = EXCLUDED.primarykeys, columns = EXCLUDED.columns,
  details = EXCLUDED.details, searchfields = EXCLUDED.searchfields,
